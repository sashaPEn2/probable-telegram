...
export const GROUPS_BY_COURSE: Record<number, string[]> = {
  1: [
    '26ДКС-1', '26ДКП-1', '26ДКП-2', '26ДКЭ', '26ДКТ', 
    '26ДКХ-1', '26ДКХ-2', '26ДКУ', '26ДКР'
  ],
  2: [
    '25ДКС-1', '25ДКП-1', '25ДКП-2', '25ДКЭ', '25ДКТ', 
    '25ДКА-1', '25ДКА-2', '25ДКУ', '25ДКР'
  ],
  3: [
    '24ДКС-1', '24ДКП-1', '24ДКП-2', '24ДКЭ', '24ДКТ', 
    '24ДКА-1', '24ДКА-2', '24ДКУ', '24ДКР'
  ],
  4: [
    '23ДКС-1', '23ДКП-1', '23ДКП-2', '23ДКЭ', '23ДКТ', 
  ...
  db.snils = [
    {
      ...
      head_name: 'к.э.н., доцент Cтавновская Анастасия Владимировна',
      department: 'Кафедра экономики АПК и природопользования',
