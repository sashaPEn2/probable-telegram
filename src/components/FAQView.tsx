    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="text-center mb-12">
        <div className="inline-flex items-center justify-center p-3 bg-emerald-100 dark:bg-emerald-900/30 rounded-2xl mb-4">
          <HelpCircle className="w-8 h-8 text-[#052e16] dark:text-emerald-400" />
        </div>
        <h1 className="text-3xl font-black text-[#052e16] dark:text-emerald-200 mb-2">База знаний SNO.PORTAL</h1>
          ...
          >
            ...
            >
              <div className="flex items-center space-x-4">
                <div className={`p-2 rounded-xl transition-colors ${openIndex === index ? 'bg-[#052e16] text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-500'}`}>
                  {item.icon}
                </div>
                <div>
                  ...
                  <h3 className="font-bold text-[#052e16] dark:text-emerald-200 text-sm sm:text-base">
                    {item.question}
                  </h3>
                </div>
              </div>
      ...
      <div className="mt-12 p-8 rounded-3xl bg-gradient-to-br from-[#052e16] to-emerald-900 text-white text-center shadow-xl">
        ...
        <a 
          ...
          target="_blank" 
          rel="noreferrer"
          className="inline-flex items-center space-x-2 px-8 py-4 bg-[#10b981] text-[#052e16] font-black rounded-2xl shadow-lg hover:brightness-110 transition-all active:scale-95"
        >
